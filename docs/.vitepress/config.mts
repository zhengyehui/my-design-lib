...
export default defineConfig({
  ...
  head: [
    // SEO 基础 meta
    ['meta', { name: 'description', content: 'My Design Lib — 为 AI 编程助手优化的前端设计库。25 个纯 HTML+CSS 组件，56 个完整页面灵感，Design Tokens，零框架依赖，复制即用。' }],
    ...
    ['meta', { property: 'og:description', content: '为 AI 编程助手优化的前端设计库。25 个组件 + 56 个完整页面，纯 HTML+CSS，零依赖。' }],
    ...
    ['meta', { name: 'twitter:description', content: '为 AI 编程助手优化的前端设计库。25 个组件 + 56 个完整页面，纯 HTML+CSS，零依赖。' }],
    ...
    ['script', { type: 'application/ld+json' }, JSON.stringify({
      ...
      "name": "My Design Lib",
      "description": "为 AI 编程助手优化的前端设计库，包含 25 个组件和 56 个完整页面",
