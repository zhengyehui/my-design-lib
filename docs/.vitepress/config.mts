...
export default defineConfig({
  ...
  head: [
    // SEO 基础 meta
    ['meta', { name: 'description', content: 'My Design Lib — 为 AI 编程助手优化的前端设计库。25 个纯 HTML+CSS 组件，190 个完整页面灵感，Design Tokens，零框架依赖，复制即用。' }],
    ...
    ['meta', { property: 'og:description', content: '为 AI 编程助手优化的前端设计库。25 个组件 + 190 个完整页面，纯 HTML+CSS，零依赖。' }],
    ...
    ['meta', { name: 'twitter:description', content: '为 AI 编程助手优化的前端设计库。25 个组件 + 190 个完整页面，纯 HTML+CSS，零依赖。' }],
    ...
    ['script', { type: 'application/ld+json' }, JSON.stringify({
      ...
      "name": "My Design Lib",
"description": "为 AI 编程助手优化的前端设计库，包含 25 个组件和 190 个完整页面",
    ...
    ['meta', { name: 'ai-description', content: '前端设计库：25个HTML+CSS组件，190个完整页面模板，Design Tokens。可直接复制使用。' }],
      ...
      '/pages/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'KAZE 日本清酒酿造所', link: '/pages/kaze-sake-brewery' }
          ]
        },
        {
          text: '💼 作品集 & 机构',
          ...
          items: [
            ...
            { text: 'KAEL 音乐艺术家作品集', link: '/pages/music-artist-portfolio' },
            { text: 'Maren Vogt 产品设计师', link: '/pages/product-designer-portfolio' },
            { text: 'Vertex Studio 3D 艺术家', link: '/pages/vertex-3d-portfolio' }
          ]
        },
        {
          text: '📊 应用 & 仪表盘',
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Stride Lab 运动鞋商城', link: '/pages/stride-lab' },
            { text: 'BÉCANE 骑行时装', link: '/pages/cycling-couture' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Community Hub 社区论坛', link: '/pages/community-hub' },
            { text: 'Maison Journal 生活杂志', link: '/pages/maison-journal' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Pawlished 宠物美容沙龙', link: '/pages/pawlished-grooming' }
          ]
        }
      ]
    },
