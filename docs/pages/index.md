...
const pages = [
  ...
  {
    id: 'cacao-co',
    title: 'Cacao & Co 手工巧克力电商',
    category: 'ecommerce',
    tags: ['电商', '巧克力', '奢华', '暗色Hero', '衬线字体'],
    colors: ['#1a0e0a', '#c9a96e', '#faf5ee'],
    rating: 9.4,
    description: '奢华手工巧克力品牌电商，Cormorant Garamond 衬线字体 + 深巧克力棕配色 + CSS 巧克力条插画 + 可可粉粒子动画 + Marquee 产地滚动 + 品牌故事双栏 + 风味卡片',
  },
  {
    id: 'lumina-dental',
