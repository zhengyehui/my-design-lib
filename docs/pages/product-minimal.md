...
<div class="page-detail">
  ...
  <!-- SEO Meta -->
  <meta name="description" content="极简产品落地页模板，灵感来自 Tatem/Amie，包含产品预览窗口、特性网格、分栏展示、CTA 区域，纯 HTML+CSS 零依赖。">
  <meta name="keywords" content="产品落地页, 极简设计, SaaS模板, 产品展示">
  <meta name="robots" content="index, follow">
  <meta property="og:type" content="article">
  <meta property="og:title" content="FlowDesk 极简产品页 — My Design Lib">
  <meta property="og:description" content="极简产品落地页模板，灵感来自 Tatem/Amie，包含产品预览、特性网格、分栏展示。">
  <meta property="og:url" content="http://101.37.166.208:11930/pages/product-minimal.html">
  <link rel="canonical" href="http://101.37.166.208:11930/pages/product-minimal.html">
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"CreativeWork","name":"FlowDesk 极简产品页 — My Design Lib","description":"极简产品落地页模板，灵感来自 Tatem/Amie，包含产品预览、特性网格、分栏展示。","url":"http://101.37.166.208:11930/pages/product-minimal.html","genre":"landing","author":{"@type":"Organization","name":"My Design Lib"}}</script>


  <div class="detail-header">
    <a href="/pages/" class="back-link">← 返回画廊</a>
    <div class="detail-meta">
      <h1>FlowDesk 极简产品页</h1>
      <div class="detail-tags">
        <span class="tag">产品页</span><span class="tag">极简</span><span class="tag">SaaS</span><span class="tag">产品预览</span>
    ...
    <div class="detail-actions">
      ...
      <a href="/pages/product-minimal/index.html" target="_blank" class="action-btn">↗ 新窗口打开</a>
    </div>
  </div>

  <div class="detail-body">
    <div id="preview-panel" class="panel"><iframe src="/pages/product-minimal/index.html" sandbox="allow-scripts" loading="lazy"></iframe></div>
  ...
  <div class="design-tips">
    <h2>💡 设计分析</h2>
    <div class="tips-grid">
      <div class="tip"><h3>布局结构</h3><p>经典产品落地页：固定导航 → Hero（大标题+产品预览窗口）→ 特性网格 → 分栏功能展示 → CTA → 页脚</p></div>
      <div class="tip"><h3>配色方案</h3><p>极简黑白灰为主，深色文字 (#0f172a) 搭配浅灰背景。无主色强调，依靠排版和留白创造高级感。</p></div>
      <div class="tip"><h3>亮点技巧</h3><p>• Hero 区嵌入产品预览窗口（模拟桌面）<br>• 侧边栏+收件箱列表展示产品界面<br>• 统计数据卡片展示产品性能<br>• 极简 CTA 区域突出转化</p></div>
      <div class="tip"><h3>适用场景</h3><p>生产力工具、邮件客户端、SaaS 产品、需要展示产品界面的落地页</p></div>
    </div>
  </div>
  ...
  <div class="detail-footer">
    ...
    <div class="nav-prevnext">
      ...
      <a href="/pages/saas-landing.html">NovaPay SaaS 落地页 →</a>
    </div>
  </div>
</div>
